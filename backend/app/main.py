...
def _ensure_oven_hours_columns() -> None:
    """给已有库的 ovens 表补 open_min/close_min（create_all 不会加列）。"""
    cols = {c["name"] for c in inspect(engine).get_columns("ovens")}
